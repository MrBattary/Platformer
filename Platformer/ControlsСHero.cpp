...
void ConsoleCheck(Hero MainHero, float time,bool timecheck, bool speedXH, bool speedHY, bool cooldownJump, bool cooldownSlide, bool comboTimer)		//ТЕХH функция вывода значений из класса на экран
{

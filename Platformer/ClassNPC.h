...
class NPC {
protected:
	float xN = 0.f;						//Положение виртуальной модели по х
	float yN = 0.f;						//Положение виртуальной модели по y
	float wN = 0.f;						//Ширина модели	для конструктора
	float hN = 0.f;						//Высота модели для конструктора
	float xNReal = 0.f;					//Х реальной модели внутри виртуальной модели относительной всей оси
	float yNReal = 0.f;					//Y реальной модели внутри виртуальной модели относительной всей оси
	float xNRealInside = 0.f;			//Х реальной модели внутри виртуальной модели
	float yNRealInside = 0.f;			//Y реальной модели внутри виртуальной модели
	float wNRealInside = 0.f;			//Ширина реальной модели внутри виртуальной модели
	float hNRealInside = 0.f;			//Высота реальной модели внутри виртуальной модели
	...
	signed int layerN = 1;				//Слой отрисовки
